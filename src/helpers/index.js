...
export const RESPONSE = {
  film: {
    ...
    rating: 5,
    posterImage:
      "https://upload.wikimedia.org/wikipedia/ru/thumb/3/35/Pulp_Fiction_Soundtrack.jpg/274px-Pulp_Fiction_Soundtrack.jpg",
    additional:
      "Знакомые типажи из подпольного мира заговорили по-новому. Самый влиятельный фильм 1990-х от Квентина Тарантино",
    comments: ["Me First", "Nice", "Amazing", "Fail", "I love sneekers", "Hello, I am a programmer"],
...
export const FILMLIST = {
  ...
  results: [
    ...
    },
    {
      ...
      overview: "The penultimate installment of the Fast and Furious franchise.",
      popularity: 1093.149,
    ...
    },
    {
      ...
      popularity: 827.304,
      poster_path: "/6fT8OUMd42N0Jh3lwRf9GAI0X92.jpg",
